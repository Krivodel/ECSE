...
{
    internal class UnityMethodsManager : MonoBehaviour
    {
        internal static UnityMethodsManager Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new GameObject("[UnityMethodsManager]").AddComponent<UnityMethodsManager>();
        ...
        private static UnityMethodsManager _instance;
